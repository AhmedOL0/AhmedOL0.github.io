  ...
  work: {
    ...
    projects: [
      { title: 'OdemLab — AI skincare e-commerce', year: 'Flagship', kind: 'Team of 4 · Private repo', heading: 'OdemLab', lead: 'd',
        description: 'What I built: a full e-commerce platform with a Spring Boot API, Next.js storefront and back-office, and a React Native mobile app. Why it matters: customers pay through Stripe, Moroccan CMI, or cash-on-delivery — all routed through one order lifecycle. AI skin analysis via Gemini degrades gracefully behind circuit breakers. Trilingual FR/EN/AR with real Arabic RTL layout. Deploys to Cloud Run with zero-traffic promotion and auto-rollback on health-check failure.',
      ...
      { title: 'Medical appointment platform', year: '2025', kind: 'Internship · Full-stack', heading: 'Medical', lead: 'e',
        description: 'What I built: a doctor–patient booking system where patients search practitioners, pick time slots, and book without double-booking conflicts. Why it matters: role-based dashboards for patients, practitioners, and admins show real-time activity — eliminating manual scheduling overhead.',
      ...
      { title: 'FitTrack — training platform', year: '2025', kind: 'Solo · Full-stack', heading: 'FitTrack', lead: 'i',
        description: 'What I built: a cloud workout tracker where an AI model generates personalized training sessions based on goals and progress. Why it matters: token-based auth and a fully containerized stack mean it runs the same on any machine — no "works on my laptop" surprises.' },
      { title: 'Smart Campus Companion', year: '2026', kind: 'Team · Mobile + AR', heading: 'Campus', lead: 'a',
        description: 'What I built: an AR navigation app for ENSIASD campus — point your phone and get indoor turn-by-turn guidance. Why it matters: students find empty rooms in real time, receive push notifications for events, and administrators control access by role.' },
      { title: 'SmartSummarizer', year: '2025', kind: 'Solo · Machine learning', heading: 'Summarizer', lead: 'u',
        description: 'What I built: a document summarizer using Transformer models that also generates quiz questions and mind maps. Why it matters: students upload lecture notes and get structured study material in seconds — turning hours of reading into focused review.' },
      { title: 'Fish-box counting line', year: '2024 · DUT thesis', kind: 'Embedded · Final-year project', heading: 'IoT', lead: 'T',
        description: 'What I built: an IR-sensor counting system on ESP8266 microcontrollers that logs fish-box counts to a web dashboard in real time. Why it matters: in a factory, measurement accuracy IS the product — manual counting loses money, this system does not.' },
    ],
  },
  about: {
  ...
  work: {
    ...
    projects: [
      { title: 'OdemLab — e-commerce cosmétique IA', year: 'Vitrine', kind: 'Équipe de 4 · Dépôt privé', heading: 'OdemLab', lead: 'd',
        description: 'Ce que j\'ai construit : une plateforme e-commerce complète avec API Spring Boot, boutique Next.js et back-office, et application React Native. Pourquoi c\'est important : les clients paient par Stripe, CMI marocaine ou contre-remboursement — tout passe par un seul cycle de commande. L\'analyse IA de la peau par Gemini dégrade gracieusement derrière des coupe-circuits. Trilingue FR/EN/AR avec vrai disposition RTL arabe. Déploiement Cloud Run sans trafic et retour arrière automatique.',
      ...
      { title: 'Plateforme de rendez-vous médicaux', year: '2025', kind: 'Stage · Full-stack', heading: 'Médical', lead: 'e',
        description: 'Ce que j\'ai construit : un système de réservation médecins-patients où les patients cherchent des praticiens, choisissent des créneaux et réservent sans double réservation. Pourquoi c\'est important : les tableaux de bord par rôle pour patients, praticiens et admins montrent l\'activité en temps réel — éliminant la planification manuelle.',
      ...
      { title: 'FitTrack — suivi sportif', year: '2025', kind: 'Solo · Full-stack', heading: 'FitTrack', lead: 'i',
        description: 'Ce que j\'ai construit : un tracker d\'entraînement cloud où un modèle IA génère des séances personnalisées selon les objectifs. Pourquoi c\'est important : l\'authentification par jeton et l\'empilage conteneurisé garantissent le même fonctionnement sur toute machine — pas de surprise « ça marche sur mon ordi ».' },
      { title: 'Smart Campus Companion', year: '2026', kind: 'Équipe · Mobile + RA', heading: 'Campus', lead: 'a',
        description: 'Ce que j\'ai construit : une application de navigation AR pour le campus ENSIASD — pointez votre téléphone pour un guidage intérieur pas à pas. Pourquoi c\'est important : les étudiants trouvent des salles libres en temps réel, reçoivent des notifications push, et les administrateurs contrôlent l\'accès par rôle.' },
      { title: 'SmartSummarizer', year: '2025', kind: 'Solo · Apprentissage auto', heading: 'Résumeur', lead: 'u',
        description: 'Ce que j\'ai construit : un résumeur de documents utilisant des modèles Transformers qui génère aussi des quiz et cartes mentales. Pourquoi c\'est important : les étudiants téléchargent leurs notes et obtiennent du matériel de révision structuré en quelques secondes.' },
      { title: 'Comptage de boîtes de poisson', year: '2024 · PFE DUT', kind: 'Embarqué · Projet de fin d\'études', heading: 'IoT', lead: 'T',
        description: 'Ce que j\'ai construit : un système de comptage par capteurs IR sur ESP8266 qui enregistre les boîtes de poisson en temps réel sur un tableau de bord web. Pourquoi c\'est important : en usine, la précision de mesure EST le produit — le comptage manuel perd de l\'argent, ce système non.' },
    ],
  },
  about: {
  ...
  work: {
    ...
    projects: [
      { title: 'OdemLab — تجارة التجميل بالذكاء الاصطناعي', year: 'الأبرز', kind: 'فريق من 4 · مستودع خاص', heading: 'OdemLab', lead: 'd',
        description: 'ما بنيته: منصة تجارة إلكترونية كاملة مع API Spring Boot، متجر Next.js ومكتب خلفي، وتطبيق React Native. لماذا هو مهم: العملاء يدفعون عبر Stripe أو CMI المغربية أو الدفع عند الاستلام — الكل يمر بدورة طلب واحدة. تحليل البشرة بالذكاء الاصطناعي من Gemini يتدهور بGrace خلف Circuit Breakers. ثلاث لغات FR/EN/AR مع تخطيط RTL عربي حقيقي. نشر على Cloud Run بدون توقف مع رجوع تلقائي.',
      ...
      { title: 'منصة المواعيد الطبية', year: '2025', kind: 'تدريب · Full-stack', heading: 'طبي', lead: 'ب',
        description: 'ما بنيته: نظام حجز أطباء-مرضى حيث يبحث المرضى عن الممارسين، يختارون المواعيد ويحجزون دون تعارض. لماذا هو مهم: لوحات الأدوار للمرضى والممارسين والإداريين تُظهر النشاط لحظياً — ت eliminates الجدولة اليدوية.',
        note: 'مشروع زبون — التفاصيل عند الطلب.' },
      { title: 'FitTrack — منصة رياضية', year: '2025', kind: 'فردي · Full-stack', heading: 'FitTrack', lead: 'i',
        description: 'ما بنيته: متتبع تمارين سحابي حيث يولد نموذج ذكاء اصطناعي حصصاً مخصصة حسب الأهداف. لماذا هو مهم: مصادقة بالرموز والحجم المُحتوى يضمنان نفس العمل على أي جهاز — لا مفاجآت « يعمل على جهازي فقط ».' },
      { title: 'رفيق الحرم الذكي', year: '2026', kind: 'فريق · موبايل + AR', heading: 'Campus', lead: 'a',
        description: 'ما بنيته: تطبيق ملاحة بالواقع المعزز لحرم ENSIASD — وجّه هاتفك للحصول على إرشاد داخلي خطوة بخطوة. لماذا هو مهم: الطلاب يجدون قاعات فارغة لحظياً، يتلقون إشعارات، والإداريون يتحكمون في الوصول حسب الدور.' },
      { title: 'SmartSummarizer', year: '2025', kind: 'فردي · تعلم آلي', heading: 'ملخص', lead: 'خ',
        description: 'ما بنيته: مُلخِّص مستندات يستخدم نماذج Transformer ويوّلد أيضاً اختبارات وخرائط ذهنية. لماذا هو مهم: الطلاب يرفعون ملاحظاتهم ويحصلون على مواد مراجعة منظمة في ثوانٍ.' },
      { title: 'عدّ علب السمك', year: '2024 · مشروع التخرج', kind: 'مدمج · مشروع النهاية', heading: 'IoT', lead: 'T',
        description: 'ما بنيته: نظام عد بحساسات IR على ESP8266 يسجّل علب السمك لحظياً على لوحة ويب. لماذا هو مهم: في المصنع، دقة القياس هي المنتج — العد اليدوي يخسر المال، هذا النظام لا يخسر.' },
    ],
  },
  about: {
