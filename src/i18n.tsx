  ...
  work: {
    ...
    projects: [
      ...
      { title: 'FitTrack — training platform', year: '2025', kind: 'Team of 2 · Full-stack', heading: 'FitTrack', lead: 'i',
        ...
        result: '38 exercises, 3 Docker containers, 3 user roles. Full admin moderation pipeline.' },
  ...
  work: {
    ...
    projects: [
      ...
      { title: 'FitTrack — suivi sportif', year: '2025', kind: 'Équipe de 2 · Full-stack', heading: 'FitTrack', lead: 'i',
        ...
        result: '38 exercices, 3 conteneurs Docker, 3 rôles. Pipeline complet de modération admin.' },
