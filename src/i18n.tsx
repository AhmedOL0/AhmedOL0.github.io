  ...
  work: {
    ...
    projects: [
      ...
      { title: 'Smart Campus Companion', year: '2026', kind: 'Team of 4 · Flutter', heading: 'Campus', lead: 'a',
        ...
        result: '3 roles, 7 Firestore collections, real-time sync. QR-to-room info in one scan.' },
  ...
  work: {
    ...
    projects: [
      ...
      { title: 'Smart Campus Companion', year: '2026', kind: 'Équipe de 4 · Flutter', heading: 'Campus', lead: 'a',
        ...
        result: '3 rôles, 7 collections Firestore, synchronisation temps réel. Info salle en un scan.' },
