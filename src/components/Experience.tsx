...
export function Timeline({ items }: { items: typeof jobs }) {
  return (
...
export default function Experience() {
  return (
    <Section id="experience" num="03" kicker="Track record" title="Experience & education.">
      <Timeline items={jobs} />
    </Section>
  );
}
...
export function Education() {
  return (
    <Section
      id="education" num="04" kicker="Education"
      title="Schools, not jobs."
      sub="The two formations behind the work above."
    >
